  ...
  return (
    <div className='mt-8 flex flex-col lg:flex-row gap-8'>
      ...
      <div className='w-full lg:w-1/2 flex flex-col gap-4'>
        ...
        <Link to='/slug' className='text-xl lg:text-3xl font-semibold lg:font-bold'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</Link>
      </div>
      ...
      <div className='w-full lg:w-1/2 flex flex-col gap-4'>
        ...
        <div className='w=2/3'>
          ...
          <Link to='/slug' className='text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</Link>
        </div>
